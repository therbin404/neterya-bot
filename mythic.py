...
@tree.command(name="mythics", description="Show chests based on mythics plus done", guild=discord.Object(id=int(os.getenv('DISCORD_ID'))))
...
@client.event
async def on_ready():
    await tree.sync(guild=discord.Object(id=int(os.getenv('DISCORD_ID'))))
    print("Ready!")
